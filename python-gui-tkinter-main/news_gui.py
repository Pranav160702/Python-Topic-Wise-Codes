...
class NewsApp:
    ...
    def __init__(self):
        ...
        # Fetch Data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=adc8b99afcd14c0cad5b6384395f0dab').json()
    ...
    def load_news(self, index):
        ...
        heading = Label(self.root,text=self.data['articles'][index]['title'], bg='black',fg='white',wraplength=340,justify='center')
        heading.pack(pady=(10,20))
        heading.config(font=('verdana', 10, 'bold'))

        desc = Label(self.root,text=self.data['articles'][index]['description'], bg='black',fg='white',wraplength=350,justify='center')
